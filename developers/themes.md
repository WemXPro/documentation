...
5. Duplicate the default Pterodactyl Service folder `app\Services\Pterodactyl\Resources\views\client\tailwind` to `app\Services\Pterodactyl\Resources\views\client\material`
